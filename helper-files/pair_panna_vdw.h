...
PairStyle(panna/vdw, PairPANNAvdw)

#else

#ifndef LMP_PAIR_PANNA_vdw_H
#define LMP_PAIR_PANNA_vdw_H
...
class PairPANNAvdw : public Pair {
public:
  PairPANNAvdw(class LAMMPS *);
  virtual ~PairPANNAvdw();
